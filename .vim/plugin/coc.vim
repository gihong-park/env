...
function! MyTest()
	echo coc#float#get_float_win_list()
endfunc

nnoremap <C-e> MyTest()

nnoremap <expr> <C-k> coc#float#has_scroll() ? coc#float#scroll(0) : ""
nnoremap <expr> <C-j> coc#float#has_scroll() ? coc#float#scroll(1) : ""

" nnoremap  <C-j> coc#float#has_scroll() ? coc#float#scroll(0) : "\<C-b>"
" Remap <C-f> and <C-b> to scroll float windows/popups
" if has('nvim-0.4.0') || has('patch-8.2.0750')
"   noremap <silent><nowait><expr> <C-k> coc#float#has_scroll() ? coc#float#scroll(1) : "\<C-f>"
"   noremap <silent><nowait><expr> <C-h> coc#float#has_scroll() ? coc#float#scroll(0) : "\<C-b>"
